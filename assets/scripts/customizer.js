...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-harmonium_header_button select' ),
			headerLinkButton: $( '#customize-control-harmonium_header_button_url' ),
			headerLinkText: $( '#customize-control-harmonium_header_button_text' )
		};
	};
