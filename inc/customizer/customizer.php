 ...
 */
function harmonium_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'harmonium_remove_default_customizer_sections', 15 );
 ...
 * @author WDS
 */
function harmonium_include_custom_controls() {
...
add_action( 'customize_register', 'harmonium_include_custom_controls', -999 );
 ...
 */
function harmonium_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = array(
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'harmonium_copyright_text' => '.site-info',
	);
...
add_action( 'customize_register', 'harmonium_selective_refresh_support' );
 ...
 */
function harmonium_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'harmonium_live_preview_support', 999 );
