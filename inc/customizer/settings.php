 ...
 * @author WDS
 */
function harmonium_customize_additional_scripts( $wp_customize ) {

	// Register a setting.
	$wp_customize->add_setting(
		'harmonium_header_scripts',
		array(
			'default'           => '',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'     => 'harmonium_additional_scripts_section',
			'type'        => 'textarea',
		)
	);
...
add_action( 'customize_register', 'harmonium_customize_additional_scripts' );
 ...
 * @param object $wp_customize Instance of WP_Customize_Class.
 */
function harmonium_customize_social_icons( $wp_customize ) {
	...
	foreach ( $social_networks as $network ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'section' => 'harmonium_social_links_section',
				'type'    => 'text',
			)
		);
	}
}
add_action( 'customize_register', 'harmonium_customize_social_icons' );
 ...
 * @param object $wp_customize Instance of WP_Customize_Class.
 */
function harmonium_customize_copyright_text( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Text_Editor_Custom_Control(
			...
			array(
				...
				'section'     => 'harmonium_footer_section',
				'type'        => 'textarea',
			)
		)
	);
}
add_action( 'customize_register', 'harmonium_customize_copyright_text' );
 ...
 * @param object $wp_customize Instance of WP_Customize_Class.
 */
function harmonium_customize_header_button( $wp_customize ) {

	// Register a setting.
	$wp_customize->add_setting(
		'harmonium_header_button',
		array(
			'default'           => '',
			'sanitize_callback' => 'harmonium_sanitize_select',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'     => 'harmonium_header_section',
			'type'        => 'select',
			'choices'     => array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'         => 'harmonium_header_section',
			'type'            => 'url',
			'active_callback' => 'harmonium_customizer_is_header_button_link', // Only displays if the Link option is selected above.
		)
	);

	// Register a setting for the link text.
	$wp_customize->add_setting(
		'harmonium_header_button_text',
		array(
			'default'           => '',
...
add_action( 'customize_register', 'harmonium_customize_header_button' );
 ...
 */
function harmonium_sanitize_select( $input, $setting ) {
 ...
 * @author Corey Collins
 */
function harmonium_customizer_is_header_button_link() {
