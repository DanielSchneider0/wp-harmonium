...
function harmonium_acf_init() {
	...
	acf_register_block_type(
		array(
			'name'            => 'wds-accordion',
			'title'           => esc_html__( 'Accordion', 'harmonium' ),
			'description'     => esc_html__( 'A custom set of collapsable accordion items.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'sort',
			'keywords'        => array( 'accordion', 'wds' ),
			'mode'            => 'preview',
			'enqueue_assets'  => 'harmonium_acf_enqueue_accordion_scripts',
			'align'           => 'wide',
			'supports'        => $supports,
			'example'         => array(
				'attributes' => array(
					'data' => array(
						'title'           => esc_html__( 'Accordion Block Title', 'harmonium' ),
						'text'            => esc_html__( 'Accordion Block Content', 'harmonium' ),
						'accordion_items' => array(
							'0' => array(
								'accordion_title' => esc_html__( 'Accordion Item Title', 'harmonium' ),
								'accordion_text'  => esc_html__( 'Accordion Item Content', 'harmonium' ),
							),
						),
					),
				),
	...
	acf_register_block_type(
		array(
			'name'            => 'wds-carousel',
			'title'           => esc_html__( 'Carousel', 'harmonium' ),
			'description'     => esc_html__( 'A carousel with a call to action for each slide.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'slides',
			'keywords'        => array( 'carousel', 'slider', 'wds' ),
			'mode'            => 'preview',
			'enqueue_assets'  => 'harmonium_acf_enqueue_carousel_scripts',
			'align'           => 'wide',
			'supports'        => $supports,
			'example'         => array(
				'attributes' => array(
	...
	acf_register_block_type(
		array(
			'name'            => 'wds-cta',
			'title'           => esc_html__( 'Call To Action', 'harmonium' ),
			'description'     => esc_html__( 'A call to action block.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'megaphone',
			'keywords'        => array( 'call to action', 'cta', 'wds' ),
			'mode'            => 'preview',
			'enqueue_assets'  => 'harmonium_acf_enqueue_backend_block_styles',
			'align'           => 'wide',
			'supports'        => $supports,
			'example'         => array(
				'attributes' => array(
					'data' => array(
						'title'       => esc_html__( 'Call To Action Title', 'harmonium' ),
						'text'        => esc_html__( 'Call To Action Text', 'harmonium' ),
						'button_link' => array(
							'title' => esc_html__( 'Learn More', 'harmonium' ),
							'url'   => '#',
						),
					),
				),
	...
	acf_register_block_type(
		array(
			...
			'title'           => esc_html__( 'Fifty/Fifty Block', 'harmonium' ),
			'description'     => esc_html__( 'A split-content block with text and/or media.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'editor-table',
			...
			'example'         => array(
				'attributes' => array(
					'data' => array(
						'text_primary' => esc_html__( 'Primary Text content', 'harmonium' ),
						'media_right'  => array(
	...
	acf_register_block_type(
		array(
			'name'            => 'wds-hero',
			'title'           => esc_html__( 'Hero Block', 'harmonium' ),
			'description'     => esc_html__( 'A hero with an optional call to action.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'slides',
	...
	acf_register_block_type(
		array(
			...
			'title'           => esc_html__( 'Recent Posts Block', 'harmonium' ),
			'description'     => esc_html__( 'A set of recent posts displayed by category and/or tag.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'admin-page',
	...
	acf_register_block_type(
		array(
			...
			'title'           => esc_html__( 'Related Posts Block', 'harmonium' ),
			'description'     => esc_html__( 'A set of manually selected posts.', 'harmonium' ),
			'render_callback' => 'harmonium_acf_block_registration_callback',
			'category'        => 'harmonium',
			'icon'            => 'admin-page',
...
add_action( 'acf/init', 'harmonium_acf_init' );
 ...
 * @author Corey Collins
 */
function harmonium_acf_block_registration_callback( $block ) {
	...
	if ( ! is_admin() && harmonium_has_block_expired(
		array(
	...
	harmonium_display_expired_block_message();
 ...
 * @author Corey Collins
 */
function harmonium_add_block_categories( $categories, $post ) {
	...
	return array_merge(
		...
		array(
			array(
				'slug'  => 'harmonium',
				'title' => esc_html__( 'Harmonium Blocks', 'harmonium' ),
			),
		)
	);
}
add_filter( 'block_categories', 'harmonium_add_block_categories', 10, 2 );
 ...
 * @author Corey Collins
 */
function harmonium_acf_enqueue_backend_block_styles() {
 ...
 * @author Corey Collins
 */
function harmonium_acf_enqueue_carousel_scripts() {

	if ( ! is_admin() ) {
		return;
	}

	harmonium_acf_enqueue_backend_block_styles();
 ...
 * @author Corey Collins
 */
function harmonium_acf_enqueue_accordion_scripts() {
 ...
 * @author Corey Collins
 */
function harmonium_get_block_alignment( $block ) {
 ...
 * @author Corey Collins
 */
function harmonium_get_block_classes( $block ) {
	...
	$classes  = '';
	$classes  = harmonium_get_block_expired_class();
 ...
 * @author Corey Collins
 */
function harmonium_get_block_expired_class() {
	...
	if ( harmonium_has_block_expired(
		array(
 ...
 * @author Corey Collins
 */
function harmonium_display_expired_block_message() {

	if ( ! harmonium_get_block_expired_class() ) {
		return;
	}

	?>
	<div class="block-expired-message">
		<span class="block-expired-text"><?php esc_html_e( 'Your block has expired. Please change or remove the Start and End dates under Other Options to display your block on the frontend.', 'harmonium' ); ?></span>
	</div>
	<?php
}
 ...
 * @author Corey Collins
 */
function harmonium_get_block_id( $block ) {
 ...
 * @author Corey Collins
 */
function harmonium_acf_gutenberg_display_admin_default_carousel( $block ) {
	...
	for ( $slides = 0; $slides < 2; $slides++ ) :
		...
		<section class="slide">
			<div class="slide-content container">
				<h2 class="slide-title"><?php esc_html_e( 'Slide Title', 'harmonium' ); ?></h2>
				<p class="slide-description"><?php esc_html_e( 'Slide Content', 'harmonium' ); ?></p>
			</div>
		</section>
	<?php
	endfor;
